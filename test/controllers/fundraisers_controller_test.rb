...
class FundraisersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fundraiser" do
    assert_difference('Fundraiser.count') do
      post fundraisers_url, params: { fundraiser: { description: @fundraiser.description, funds_aim: @fundraiser.funds_aim, funds_current: @fundraiser.funds_current, funds_percentage: @fundraiser.funds_percentage, payments_total_count: @fundraiser.payments_total_count, title: @fundraiser.title } }
    end
  ...
  test "should update fundraiser" do
    patch fundraiser_url(@fundraiser), params: { fundraiser: { description: @fundraiser.description, funds_aim: @fundraiser.funds_aim, funds_current: @fundraiser.funds_current, funds_percentage: @fundraiser.funds_percentage, payments_total_count: @fundraiser.payments_total_count, title: @fundraiser.title } }
