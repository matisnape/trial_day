...
ActiveRecord::Schema.define(version: 2019_04_22_145700) do

  create_table "fundraisers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.integer "funds_aim"
